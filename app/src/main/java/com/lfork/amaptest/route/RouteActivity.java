package com.lfork.amaptest.route;
...
import com.lfork.amaptest.overlay.DrivingRouteOverlay;
...
//		getIntentData();
	...
	private void init() {
		...
		mBusResultLayout = findViewById(R.id.bus_result);
		...
		mBus = findViewById(R.id.route_bus);
		mWalk = findViewById(R.id.route_walk);
		mBusResultList = findViewById(R.id.bus_result_list);
	}
